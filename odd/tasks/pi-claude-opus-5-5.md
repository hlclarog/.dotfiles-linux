...
## Next step
Publish the feature branch as authorized, without merging master. Restart Pi before using a Claude profile; a fresh Pi registry still needs manual Claude snapshot recovery.

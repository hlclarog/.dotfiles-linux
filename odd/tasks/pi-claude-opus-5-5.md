...
- [ ] T3: Independently verify tests, artifact equality and diff scope; commit the work unit and push only the selected branch if native review policy permits. Record commit and publication evidence.
...
## Next step
Independently verify and publish the selected feature branch; do not merge master.
